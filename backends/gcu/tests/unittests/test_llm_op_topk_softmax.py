...
class TestTopkSoftmax(TestAPIBase):
    ...
    def prepare_data(self):
        self.gating_output = self.generate_data([self.num_tokens, self.num_experts], self.input_dtype)
    ...
    def forward(self):
        ...
        token_expert_indices = paddle.to_tensor(self.token_expert_indices, dtype="int32")
